      ...
      children: [
        {
          ...
          label: t('SIDEBAR.SETTINGS_SECTIONS.ACCOUNT'),
        ...
        {
          name: 'Settings Section People',
          label: t('SIDEBAR.SETTINGS_SECTIONS.PEOPLE'),
        ...
        {
          name: 'Settings Section Inboxes',
          label: t('SIDEBAR.SETTINGS_SECTIONS.INBOXES'),
          icon: 'i-lucide-mailbox',
          children: [
            {
        ...
        {
          name: 'Settings Section Automation',
          label: t('SIDEBAR.SETTINGS_SECTIONS.AUTOMATION'),
        ...
        {
          name: 'Settings Section Customization',
          label: t('SIDEBAR.SETTINGS_SECTIONS.CUSTOMIZATION'),
        ...
        {
          name: 'Settings Section Integrations',
          label: t('SIDEBAR.SETTINGS_SECTIONS.INTEGRATIONS'),
          icon: 'i-lucide-plug',
          children: [
            {
